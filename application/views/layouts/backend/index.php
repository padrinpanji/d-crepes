...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo $this->config->item('assets_css');?>/bootstrap/bootstrap.css">
        <link rel="stylesheet" type="text/css" href="<?php echo $this->config->item('assets_css');?>/theme.css">
        <link rel="stylesheet" href="<?php echo $this->config->item('assets_css');?>/custom.css">
        <link rel="stylesheet" href="<?php echo $this->config->item('assets_ext');?>/font-awesome/css/font-awesome.css">

        <script src="<?php echo $this->config->item('assets_js');?>/jquery-1.10.2.js" type="text/javascript"></script>        
        <script src="<?php echo $this->config->item('assets_js');?>/bootstrap/bootstrap.js" type="text/javascript"></script>        
                            ...
                            <div id="widget2container" class="block-body collapse in">
                                <table class="table list">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <p><i class="icon-user" rel="tooltip"></i> Mark Otto</p>
                                            </td>
                                            <td>
                                                <p>Amount: $1,247</p>
                                            </td>
